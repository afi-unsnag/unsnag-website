...
- See clearly what's theirs to own (their feeling of unworthiness, their reaction) vs. what isn't (someone else's mood, someone else's response)
- Hold other people accountable instead of absorbing their emotions
- Stop passing their pain around — stop the cycle of reactivity
...
**Secondary:** Therapy (insight, not in-the-moment processing), journaling (thinking about feelings, not feeling them), mindfulness apps like Calm/Headspace (calming, not processing).
**Indirect:** Somatic coaching (right approach, requires a practitioner). Doing nothing / white-knuckling it.
**How each falls short:** They all keep you in your head or require another person. None give you a simple, repeatable way to actually feel the feeling in your body, see what's yours vs. what isn't, and make a different choice — on your own, in the moment, as many times as you need.

## Differentiation
**Key differentiators:**
- Moves you from thinking about the feeling to actually feeling it — somatic, not cognitive
- Shows you what's yours to own vs. what isn't — stops the cycle of taking responsibility for everyone else
- Self-guided and available in the moment — no practitioner, no appointment
...
| Objection | Response |
|-----------|----------|
| "Is this just journaling?" | No. Writing is involved in the Unload step, but the goal isn't to think about the feeling — it's to get it out of your head so you can move into your body. The 6-step process is somatic, not reflective. |
| "Does this actually work?" | The process is grounded in somatic psychology. A feeling fully felt lasts about 90 seconds. When you name it, locate it in your body, and hold space for it, it moves. You can't get there by thinking harder. |
| "I don't have time." | A full session is under 10 minutes. The Notice step alone is 90 seconds. This is designed for real moments — not a dedicated wellness practice. |
| "I already have a therapist." | Unsnag isn't a replacement for therapy. It's what you reach for between sessions — at 11pm when the spiral hits, in the car after a hard conversation. Therapy gives you insight. This moves the feeling. |
...
- "I've done so much work on myself and I still can't figure out why I keep doing this."
...
| Term | Meaning |
|------|---------|
| UNSNAG | The 6-step somatic process: Unload, Name, Sense, Notice, Ask, Go |
| Unload | Step 1: brain-dump what's going on, no filter — get it out of your head |
| Name | Step 2: tap the emotions that fit |
| Sense | Step 3: locate where you feel it in the body |
| Notice | Step 4: 90-second timed somatic hold — just be with the sensation |
| Ask | Step 5: what does the feeling actually want to say? |
| Go | Step 6: choose a different next action |
| AI reflection | Two moments: honest validation after Unload, and "yours vs. not yours" separation after Ask |
| Snag | A stuck emotional pattern that keeps firing |
...
**Customers:** *(Notable early testers if any)*
**Testimonials:**
